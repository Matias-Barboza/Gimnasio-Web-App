<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadoUsuarios.aspx.cs" Inherits="Gimnasio_Web.Usuarios.ListadoUsuarios" %>
    ...
    <asp:UpdatePanel class="position-fixed w-fill-available container-principal" runat="server">
        <ContentTemplate>
            <div class="border rounded mt-4 mx-5 mb-3 p-3">
                ...
                <p class="form-text form-text mt-1 mb-0 ms-2">Búsqueda por nombre de usuario, nombre y/o apellido.</p>
            </div>

            <div class="border rounded m-5 mt-2 p-3 pb-5">
                <div>
                    <h2 id="TituloListado" class="text-center" runat="server" >Listado de usuarios</h2>
                    <hr class="mt-0" />
                </div>
                <div class="max-min-height-53-vh overflow-y-scroll table-responsive border rounded">
                    <asp:GridView ID="UsuariosGridView" DataKeyNames="Id" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NombreUsuario" HeaderText="Nombre de usuario" ItemStyle-VerticalAlign="Middle" />
                            ...
                            <asp:TemplateField HeaderText="Es administrador" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <input type="checkbox" class="form-check-input" checked='<%#Eval("EsAdmin") %>' disabled="disabled" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Es profesor" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <input type="checkbox" class="form-check-input" checked='<%#Eval("EsProfesor") %>' disabled="disabled" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
